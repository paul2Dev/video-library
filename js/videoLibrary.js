export default class videoLibrary {
    ...
    renderCategoryVideos(videosContainer, renderCategory) {
        ...
        this.renderDeleteCategoryButton(videosContainer, renderCategory);
    ...
    renderDeleteCategoryButton(parentContainer, category) {
        if(category != 'all') {
            const deleteCategoryButton = document.createElement('button');
            deleteCategoryButton.classList.add('delete-category', 'text-sm', 'text-red-500', 'hover:text-red-700', 'font-medium', 'ml-2');
            deleteCategoryButton.innerHTML = `<svg aria-hidden="true" class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>`;
            parentContainer.querySelector('.category-title').appendChild(deleteCategoryButton);

            this.registerDeleteCategoryEvent(deleteCategoryButton, category);
        }
    }
    ...
    registerDeleteCategoryEvent(deleteCategoryButton, category) {
        deleteCategoryButton.addEventListener('click', function(e) {
            e.preventDefault();
            if(confirm('Are you sure you want to delete this category?')) {
                delete this.videos[category];
